...
function generate() {
  var rannum = Math.floor(Math.random() * 387) + 1;
  document.getElementById("setup").innerHTML = jokes[rannum].setup;
  document.getElementById("punchline").innerHTML = jokes[rannum].punchline;
